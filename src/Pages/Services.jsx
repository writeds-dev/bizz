  ...
  return (
    <>
      ...
      <motion.section
        ...
        variants={fadeInUp}
      >
        <div className="absolute top-6 left-6 md:left-20 text-gray-400 text-xs sm:text-sm md:text-base tracking-wide select-none">
          <span>Let’s Know</span>
          <br />
          <span className="font-semibold text-white">Services!</span>
        </div>

        <div className="max-w-6xl mx-auto w-full text-center mt-20 md:text-left">
          <h1 className="text-4xl sm:text-5xl md:text-7xl mt-5 sm:mt-20 lg:text-8xl font-extrabold leading-tight md:leading-[1.1] max-w-full md:max-w-5xl mx-auto md:mx-0">
            SOLUTIONS{" "}
      ...
      <section className="bg-black text-white py-20 px-6 md:px-20 max-w-full mx-auto select-none">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
          {servicesData.map(({ category, description, tags }) => (
            <div
              key={category}
              className="group relative border border-gray-700 rounded-3xl p-6 sm:p-8 cursor-pointer hover:shadow-lg hover:shadow-lime-500 transition-shadow duration-300 flex flex-col"
            >
              {/* Icon accent */}
              ...
              {/* Category */}
              <h3 className="text-white text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 pl-14 sm:pl-16 tracking-wide">
                {category}
              </h3>

              {/* Description */}
              <p className="text-gray-300 mb-6 sm:mb-8 pl-14 sm:pl-16 leading-relaxed flex-grow text-sm sm:text-base">
                {description}
              </p>
      ...
      <section>
        <div className="bg-black min-h-[60vh] sm:min-h-[80vh] md:min-h-screen flex flex-col justify-center items-center text-center relative text-white px-4 sm:px-6 md:px-0">
          <div className="uppercase font-extrabold text-[70px] sm:text-[90px] md:text-[120px] leading-[1]">
            <span className="inline-block mr-2 sm:mr-4 align-middle text-[60px] sm:text-[90px] md:text-[110px]">©</span>
            <span>SELECTED</span>
          </div>
          ...
          {/* Bottom right */}
          <div className="absolute bottom-4 right-4 text-white text-xs sm:text-sm">
            (04)
          </div>
        </div>
      </section>
      ...
      <section className="bg-black text-white max-w-full mx-auto px-4 sm:px-6 md:px-20 py-20 md:py-24 select-none">
        {/* Header */}
        <div className="md:flex md:justify-between md:items-center mb-16 md:mb-20 flex-col md:flex-row gap-6 md:gap-0">
        ...
        {/* Process Cards */}
        <div className="flex flex-col md:flex-row md:justify-between gap-12 md:gap-20 relative flex-wrap">
          {creativeProcessSteps.map(({ number, title, description }, idx) => (
            ...
            >
              ...
              <p className="text-gray-300 leading-relaxed text-base sm:text-lg">{description}</p>
      ...
      {/* Team Section */}
      <section className="relative bg-black min-h-screen flex flex-col md:flex-row items-center justify-between px-4 sm:px-6 md:px-20 py-16 md:py-24 text-white select-none overflow-hidden">
        {/* Left Text */}
        <div className="md:w-1/2 max-w-full mb-12 md:mb-0">
          ...
          <div className="mt-12 sm:mt-16 flex items-center gap-3 cursor-pointer group max-w-max">
            <div className="w-10 h-16 border-2 border-gray-500 rounded-3xl flex items-start justify-center relative animate-bounce">
              <FiChevronDown className="text-gray-500 text-2xl sm:text-3xl mt-1 sm:mt-2 group-hover:text-lime-400 transition-colors" />
            </div>
      ...
      {/* Collaborate Section */}
      <section className="relative bg-black min-h-[50vh] sm:min-h-[60vh] flex items-center justify-center px-4 sm:px-6 md:px-20 py-16 md:py-24 text-white select-none overflow-hidden">
        {/* Main Text */}
        <h1 className="text-center max-w-6xl mx-auto text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-extrabold leading-tight md:leading-[1.1]">
